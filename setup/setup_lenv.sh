...
# Default RECIPE 'lenv' can be overridden by 'RECIPE=foo setup.sh'
RECIPE=${RECIPE:-lenv}
# Default ENV_NAME 'lenv' can be overridden by 'ENV_NAME=foo setup.sh'
ENV_NAME="lenv"
...
echo conda env create --name="$ENV_NAME" -f setup/${RECIPE}.yml
